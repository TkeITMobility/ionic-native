...
var AndroidExoplayer = (function (_super) {
     ...
     */
    AndroidExoplayer.prototype.show = function (parameters) {
        return;
    };
    /**
     ...
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.setStream = function (url, controller) {
        return;
    };
    /**
     ...
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.playPause = function () {
        return;
    };
    /**
     * Stop playing.
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.stop = function () {
        return;
    };
    /**
     ...
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.seekTo = function (milliseconds) {
        return;
    };
    /**
     ...
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.seekBy = function (milliseconds) {
        return;
    };
    /**
     ...
     */
    AndroidExoplayer.prototype.getState = function () {
        return;
    };
    /**
     * Show the controller.
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.showController = function () {
        return;
    };
    /**
     * Hide the controller.
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.hideController = function () {
        return;
    };
    /**
     ...
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.setController = function (controller) {
        return;
    };
    /**
     ...
     * @return {Promise<void>}
     */
    AndroidExoplayer.prototype.close = function () {
        return;
    };
